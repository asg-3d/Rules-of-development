...
- [CSS-фрэймворк](#css-фрэймворк)
	- [Использование lessCSS в проектах](#использование-lesscss-в-проектах)
...
### Использование [SSI](http://ru.wikipedia.org/wiki/SSI_(программирование))
...
<a name="использование-lesscss-в-проектах"></a>
### Использование [lessCSS](http://lesscss.org/) в проектах
...
/* В lessCSS не обязательно использование расширения при подключении файла через @import */
```
...
* [lessCSS](http://lesscss.org/) — улучшенный CSS с переменными, "функциями", наследованием и вложенностью
