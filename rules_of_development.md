...
Все JavaScript-файлы должны быть в несжатом виде (в т.ч. jQuery и прочие библиотеки) — при публикации проекта, происходит сборка и сжатие при помощи сценария сборки [Gulp](http://gulpjs.com).
